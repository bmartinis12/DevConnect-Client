...
const UserWidget = ({ userId, picturePath }) => {
    ...
    const getUser = async () => {
        const response = await fetch(`https://devconnect-api.adaptable.app/users/${userId}`, {
            method: "GET", 
    ...
    const share = () => {
        navigator.clipboard.writeText(`https://aesthetic-naiad-ad420d.netlify.app/profile/${userId}`);
        setIsOpen(true);
    }
